...
<template>
  ...
  <el-form ref="formRef" :model="form" :rules="rules" label-width="130px">
    <el-card class="section">
      <template #header><b>匹配核心参数</b><span class="sec-tip">驱动相似度匹配，必填</span></template>
      <el-row :gutter="24">
        <el-col :xs="24" :sm="12">
    ...
    <el-card class="section">
      <template #header><b>工况档案</b><span class="sec-tip">选填，增强匹配精度</span></template>
      <el-row :gutter="24">
        ...
        <el-col :xs="24" :sm="12" :md="8">
          <el-form-item label="顶板类别" prop="roof_category">
            <el-select v-model="form.roof_category" placeholder="请选择" style="width: 100%">
        ...
        <el-col :xs="24" :sm="12" :md="8">
          <el-form-item label="矿压显现" prop="mine_pressure">
            <el-select v-model="form.mine_pressure" placeholder="请选择" style="width: 100%">
        ...
        <el-col :xs="24" :sm="12" :md="8">
          <el-form-item label="瓦斯等级" prop="gas_level">
            <el-select v-model="form.gas_level" placeholder="请选择" style="width: 100%">
...
.sec-tip { margin-left: 12px; font-size: 12px; color: #909399; font-weight: 400; }
